          ...
          <div class="box-body">
            ...
            <form role="form" name="guardar-blog" id="guardar-blog-archivo" method="post"
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="autor-proyecto">Foto actual del autor</label>
                  <br>
                  <img loading="lazy" src="../images/autor/<?= $blog['img_autor']; ?>" alt="Imagen del autor del blog" width="200"
                    height="200">
                </div>
                <div class="form-group">
                  <label for="autor-imagen">Editar foto del autor</label>
                ...
                <div class="form-group">
                  <label for="imagen-blog">Imagen actual del blog</label>
                  <br>
                  <img loading="lazy" src="../images/blog/<?= $blog['img_blog']; ?>" alt="Imagen del blog" width="200" height="200">
                </div>
                <div class="form-group">
                  <label for="imagen-blog">Editar imagen del blog</label>
                ...
                <div id="loader" class="form-group" style="display: none;">
                  <img src="../images/loading.gif" alt="Cargando" width="100" height="100" style="margin: 10px 0 10px 20px;">
                  <p>Espere un momento porfavor, se esta cargando la imagen...</p>
                </div>
                <div class="box-footer">
                  <input type="hidden" name="registro" value="actualizar">
                  <input type="hidden" name="id_registro" value="<?= $blog['id']; ?> ">
